---
name: designer-figma
description: Generate or update a Figma design via Figma Console MCP; or get capture ID/endpoint for capture flows. Use when user says design, /designer-figma.
