...
3. If no mismatch: coordinator proceeds to Save step 3 (updater runs [save](.claude/skills/save/SKILL.md)).

## Reference

[coordinator](.claude/agents/coordinator.md). [document-paths](.claude/skills/document-paths/SKILL.md). paths.md: Path pattern = reference; Editable section Tree = compared and updated.
